...
<div class="ae-topbar">
    <div class="ae-topbar-left">
        ...
        <span class="ae-topbar-brand">Aetheris AI</span>
    </div>
...
<div class="ae-assistant-header">
  <div class="ae-assistant-title">
    ...
    <span class="ae-assistant-name">Aetheris IA</span>
  </div>
        ...
        with col_btn_center:
            if st.button(
                ...
                if st.session_state.modo_app["modo"] == "local":
                    ...
                    if not dimensiones:
                        st.warning(
                            "⚠️ Solo se subió la tabla de hechos sin dimensiones. "
                            "La Cloud Function 'armar-cubo' espera al menos una tabla de dimensiones "
                            "para construir el cubo. El proceso continuará, pero el resultado solo "
                            "contendrá la tabla de hechos sin enriquecer."
                        )
                    try:
...
st.set_page_config(page_title="Aetheris AI", page_icon="⚡", layout="wide")
load_css("styles.css")
